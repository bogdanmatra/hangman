(function () {
    var Hangman = function (parameters) {
         ...
         * @returns {string} point.maskedWord: The updated masked word.
         * @returns {boolean} point.gameOver: True if the game is over.
         * @returns {boolean} point.gameLost: True if the game is lost.
         * @returns {boolean} point.highScore: True if there was no failed attempt.
         */
